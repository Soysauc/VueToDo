<template>
  <div class="new-todo-form">
    <div class="new-todo-form__content">
      ...
      <h2 class="new-todo-form__title">Add ToDo</h2>
    </div>
    ...
    <button class="new-todo-form__finish" @click="handleAddTodo">Finish</button>
...
export default {
  ...
  methods: {
    handleAddTodo() {
      if (!this.newTodo || !this.selectedUser || !this.selectedStatus) {
        alert("Please fill in all fields.");
        return;
      }

      const newTodoItem = {
        userId: parseInt(this.selectedUser.replace("User", "")),
        id: 0,
        title: this.newTodo,
